...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    F.prototype.config = {
            ...
            "object" == typeof a.defaultToolbar && layui.each(a.defaultToolbar, function (e, t) {
                ...
                if(i.layEvent == 'refresh'){
                    i && d.push('<div class="layui-inline" title="' + '刷新' + '" lay-event="' + i.layEvent + '"><i class="layui-icon ' + i.icon + '"></i></div>')
                }else{
            ...
            i.layBody.on("click", "." + g, function (e) {
                ...
                })), i.setThisRowChecked(a);layui.stope(event);//组织冒泡
